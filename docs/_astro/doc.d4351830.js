 ...
 */`,meta:{range:[5141,5293],filename:"euclid.mjs",lineno:127,columnno:6,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100004493",name:"_euclidRot",type:"FunctionExpression"},vars:{b:"_euclidRot~b"}},examples:[`// A thirteenth century Persian rhythm called Khafif-e-ramal.
...
so there will be no gaps.</p>`,name:"euclidLegato",memberof:"Pattern",examples:['n("g2").decay(.1).sustain(.3).euclidLegato(3,8)'],scope:"static",longname:"Pattern.euclidLegato",kind:"member"},{comment:"/** @class Class representing a pattern. */",meta:{range:[1532,26065],filename:"pattern.mjs",lineno:25,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006409",name:"exports.Pattern",type:"ClassDeclaration"}},name:"Pattern",longname:"Pattern",kind:"class",classdesc:"<p>Class representing a pattern.</p>",scope:"global",description:"<p>Create a pattern. As an end user, you will most likely not create a Pattern directly.</p>",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],memberof:"Pattern",params:[{type:{names:["function"]},description:"<p>The function that maps a {@link State} to an array of {@link Hap}.</p>",name:"query"}]},{comment:`/**
   ...
   */`,meta:{range:[2398,2507],filename:"pattern.mjs",lineno:49,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006430",name:"Pattern#withValue",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Returns a new pattern, with the function applied to the value of
each hap. It has the alias {@link Pattern#fmap}.</p>`,tags:[{originalTitle:"synonyms",title:"synonyms",text:"fmap",value:"fmap"}],params:[{type:{names:["function"]},description:"<p>to to apply to the value</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],examples:['"0 1 2".withValue(v => v + 10).log()'],name:"withValue",longname:"Pattern#withValue",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[2910,3652],filename:"pattern.mjs",lineno:70,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006466",name:"Pattern#appWhole",type:"MethodDefinition",paramnames:["whole_func","pat_val"]},vars:{"":null}},description:`<p>Assumes 'this' is a pattern of functions, and given a function to
resolve wholes, applies a given pattern of values to that
pattern of functions.</p>`,params:[{type:{names:["function"]},name:"whole_func"},{type:{names:["function"]},name:"func"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appWhole",longname:"Pattern#appWhole",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[4203,4483],filename:"pattern.mjs",lineno:106,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006573",name:"Pattern#appBoth",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>When this method is called on a pattern of functions, it matches its haps
with those in the given pattern of values.  A new pattern is returned, with
...
intersection. This applies to both the part and the whole timespan.</p>`,params:[{type:{names:["Pattern"]},name:"pat_val"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appBoth",longname:"Pattern#appBoth",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[4927,5671],filename:"pattern.mjs",lineno:127,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006609",name:"Pattern#appLeft",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>As with {@link Pattern#appBoth}, but the <code>whole</code> timespan is not the intersection,
but the timespan from the function of patterns that this method is called
on. In practice, this means that the pattern structure, including onsets,
are preserved from the pattern of functions (often referred to as the left
hand or inner pattern).</p>`,params:[{type:{names:["Pattern"]},name:"pat_val"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appLeft",longname:"Pattern#appLeft",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[5939,6684],filename:"pattern.mjs",lineno:158,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100006719",name:"Pattern#appRight",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>As with {@link Pattern#appLeft}, but <code>whole</code> timespans are instead taken from the
pattern of values, i.e. structure is preserved from the right hand/outer
...
silence`],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"queryArc",longname:"Pattern#queryArc",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[12545,12745],filename:"pattern.mjs",lineno:359,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007369",name:"Pattern#splitQueries",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with queries split at cycle boundaries. This makes
some calculations easier to express, as all haps are then constrained to
happen within a cycle.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"splitQueries",longname:"Pattern#splitQueries",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[12988,13082],filename:"pattern.mjs",lineno:374,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007409",name:"Pattern#withQuerySpan",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Returns a new pattern, where the given function is applied to the query
timespan before passing it to the original pattern.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withQuerySpan",longname:"Pattern#withQuerySpan",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[13556,13675],filename:"pattern.mjs",lineno:396,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007465",name:"Pattern#withQueryTime",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>As with {@link Pattern#withQuerySpan}, but the function is applied to both the
begin and end time of the query timespan.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withQueryTime",longname:"Pattern#withQueryTime",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[13967,14077],filename:"pattern.mjs",lineno:408,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007490",name:"Pattern#withHapSpan",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Similar to {@link Pattern#withQuerySpan}, but the function is applied to the timespans
...
present, <code>whole</code> timespans).</p>`,params:[{type:{names:["function"]},name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withHapSpan",longname:"Pattern#withHapSpan",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[14314,14397],filename:"pattern.mjs",lineno:419,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007515",name:"Pattern#withHapTime",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>As with {@link Pattern#withHapSpan}, but the function is applied to both the
begin and end time of the hap timespans.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withHapTime",longname:"Pattern#withHapTime",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[15901,16252],filename:"pattern.mjs",lineno:480,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007620",name:"Pattern#withLocation",type:"MethodDefinition",paramnames:["start","end"]},vars:{"":null}},description:`<p>Returns a new pattern with the given location information added to the
context of every hap.</p>`,params:[{type:{names:["Number"]},name:"start"},{type:{names:["Number"]},name:"end"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withLocation",longname:"Pattern#withLocation",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * Returns a new Pattern, which only returns haps that meet the given test.
   * @param {Function} hap_test - a function which returns false for haps to be removed from the pattern
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[17318,17415],filename:"pattern.mjs",lineno:523,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007832",name:"Pattern#filterHaps",type:"MethodDefinition",paramnames:["hap_test"]},vars:{"":null}},description:"<p>Returns a new Pattern, which only returns haps that meet the given test.</p>",params:[{type:{names:["function"]},description:"<p>a function which returns false for haps to be removed from the pattern</p>",name:"hap_test"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"filterHaps",longname:"Pattern#filterHaps",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * As with {@link Pattern#filterHaps}, but the function is applied to values
   * inside haps.
   * @param {Function} value_test
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[17605,17728],filename:"pattern.mjs",lineno:534,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007851",name:"Pattern#filterValues",type:"MethodDefinition",paramnames:["value_test"]},vars:{"":null}},description:`<p>As with {@link Pattern#filterHaps}, but the function is applied to values
...
query results.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"removeUndefineds",longname:"Pattern#removeUndefineds",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[18211,18476],filename:"pattern.mjs",lineno:555,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007890",name:"Pattern#onsetsOnly",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with all haps without onsets filtered out. A hap
...
as its <code>part</code> timespan.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"onsetsOnly",longname:"Pattern#onsetsOnly",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[18653,18787],filename:"pattern.mjs",lineno:568,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007905",name:"Pattern#discreteOnly",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with 'continuous' haps (those without 'whole'
timespans) removed from query results.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"discreteOnly",longname:"Pattern#discreteOnly",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @noAutocomplete
   */`,meta:{range:[18921,20366],filename:"pattern.mjs",lineno:578,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100007919",name:"Pattern#defragmentHaps",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Combines adjacent haps with the same value and whole.  Only
intended for use in tests.</p>`,tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"defragmentHaps",longname:"Pattern#defragmentHaps",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns [Hap]
   * @noAutocomplete
   */`,meta:{range:[20655,20853],filename:"pattern.mjs",lineno:633,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100008150",name:"Pattern#firstCycle",type:"MethodDefinition",paramnames:["with_context"]},vars:{"":null}},description:`<p>Queries the pattern for the first cycle, returning Haps. Mainly of use when
...
of use when comparing two patterns for equality, in tests.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"sortHapsByPart",longname:"Pattern#sortHapsByPart",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   *   .layer(x=>x.add("0,2"))
   *   .scale('C minor').note()
   */`,meta:{filename:"pattern.mjs",lineno:719,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Layers the result of the given function(s). Like {@link Pattern.superimpose}, but without the original pattern:</p>",name:"layer",memberof:"Pattern",tags:[{originalTitle:"synonyms",title:"synonyms",text:"apply",value:"apply"}],returns:[{description:"<p>Pattern</p>"}],examples:[`"<0 2 4 6 ~ 4 ~ 2 0!3 ~!5>*4"
  .layer(x=>x.add("0,2"))
   ...
   *   .scale('C minor').note()
   */`,meta:{filename:"pattern.mjs",lineno:734,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Superimposes the result of the given function(s) on top of the original pattern:</p>",name:"superimpose",memberof:"Pattern",returns:[{description:"<p>Pattern</p>"}],examples:[`"<0 2 4 6 ~ 4 ~ 2 0!3 ~!5>*4"
  .superimpose(x=>x.add(2))
   ...
   *   note("c2(3,8)")
   * )
   */`,meta:{filename:"pattern.mjs",lineno:751,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Stacks the given pattern(s) to the current pattern.</p>",name:"stack",memberof:"Pattern",examples:[`s("hh*2").stack(
  note("c2(3,8)")
   ...
   *   note("c2(3,8)")
   * )
   */`,meta:{filename:"pattern.mjs",lineno:768,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Appends the given pattern(s) to the current pattern.</p>",name:"seq",memberof:"Pattern",tags:[{originalTitle:"synonyms",title:"synonyms",text:"sequence, fastcat",value:"sequence, fastcat"}],examples:[`s("hh*2").seq(
  note("c2(3,8)")
   ...
   *   note("c2(3,8)")
   * )
   */`,meta:{filename:"pattern.mjs",lineno:782,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Appends the given pattern(s) to the next cycle.</p>",name:"cat",memberof:"Pattern",tags:[{originalTitle:"synonyms",title:"synonyms",text:"slowcat",value:"slowcat"}],examples:[`s("hh*2").cat(
  note("c2(3,8)")
 ...
 * .arpWith(haps => haps[2])
 * */`,meta:{range:[27035,27245],filename:"pattern.mjs",lineno:875,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100008874",name:"Pattern.prototype.arpWith",type:"FunctionExpression",paramnames:["func"]},vars:{"":null}},description:"<p>Selects indices in in stacked notes.</p>",examples:[`note("<[c,eb,g]!2 [c,f,ab] [d,f,ab]>")
 ...
 * */`,meta:{range:[27387,27502],filename:"pattern.mjs",lineno:888,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100008927",name:"Pattern.prototype.arp",type:"FunctionExpression",paramnames:["pat"]},vars:{"":null}},description:"<p>Selects indices in in stacked notes.</p>",examples:[`note("<[c,eb,g]!2 [c,f,ab] [d,f,ab]>")
.arp("0 [0,2] 1 [0,2]").slow(2)`],name:"arp",longname:"Pattern#arp",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
     ...
     */`,meta:{filename:"pattern.mjs",lineno:950,columnno:4,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Assumes a pattern of numbers. Adds the given number to each item in the pattern.</p>",name:"add",memberof:"Pattern",examples:[`// Here, the triad 0, 2, 4 is shifted by different amounts
"0 2 4".add("<0 3 4 0>").scale('C major').note()
// Without add, the equivalent would be:
...
// "48 52 55".add("<0 5 7 0>").note()`],scope:"static",longname:"Pattern.add",kind:"member"},{comment:`/**
     ...
     */`,meta:{filename:"pattern.mjs",lineno:967,columnno:4,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Like add, but the given numbers are subtracted.</p>",name:"sub",memberof:"Pattern",examples:[`"0 2 4".sub("<0 1 2 3>").scale('C4 minor').note()
// See add for more information.`],scope:"static",longname:"Pattern.sub",kind:"member"},{comment:`/**
     ...
     */`,meta:{filename:"pattern.mjs",lineno:977,columnno:4,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Multiplies each number by the given factor.</p>",name:"mul",memberof:"Pattern",examples:['"1 1.5 [1.66, <2 2.33>]".mul(150).freq()'],scope:"static",longname:"Pattern.mul",kind:"member"},{comment:`/**
     *
     * Divides each number by the given factor.
     * @name div
     * @memberof Pattern
     */`,meta:{filename:"pattern.mjs",lineno:986,columnno:4,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Divides each number by the given factor.</p>",name:"div",memberof:"Pattern",scope:"static",longname:"Pattern.div",kind:"member"},{comment:`/**
   ...
   *   .struct("x ~ x ~ ~ x ~ x ~ ~ ~ x ~ x ~ ~")
   *   .slow(4)
   */`,meta:{range:[33400,33488],filename:"pattern.mjs",lineno:1081,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100009453",name:"Pattern.prototype.struct",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Applies the given structure to the pattern:</p>",examples:[`note("c3,eb3,g3")
  .struct("x ~ x ~ ~ x ~ x ~ ~ ~ x ~ x ~ ~")
   ...
   */`,meta:{range:[33716,33801],filename:"pattern.mjs",lineno:1093,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100009493",name:"Pattern.prototype.mask",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Returns silence when mask is 0 or &quot;~&quot;</p>",examples:['note("c [eb,g] d [eb,g]").mask("<1 [0 1]>").slow(2)'],name:"mask",longname:"Pattern#mask",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * Resets the pattern to the start of the cycle for each onset of the reset pattern.
   *
   * @example
   * s("<bd lt> sd, hh*4").reset("<x@3 x(3,8)>")
   */`,meta:{range:[34062,34150],filename:"pattern.mjs",lineno:1105,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100009533",name:"Pattern.prototype.reset",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Resets the pattern to the start of the cycle for each onset of the reset pattern.</p>",examples:['s("<bd lt> sd, hh*4").reset("<x@3 x(3,8)>")'],name:"reset",longname:"Pattern#reset",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * Restarts the pattern for each onset of the restart pattern.
   * While reset will only reset the current cycle, restart will start from cycle 0.
   *
   * @example
   * s("<bd lt> sd, hh*4").restart("<x@3 x(3,8)>")
   */`,meta:{range:[34479,34573],filename:"pattern.mjs",lineno:1118,columnno:2,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100009573",name:"Pattern.prototype.restart",type:"FunctionExpression",paramnames:["args"]}},description:`<p>Restarts the pattern for each onset of the restart pattern.
 ...
 * slowcat(e5, b4, [d5, c5])
 *
 */`,meta:{range:[37327,38238],filename:"pattern.mjs",lineno:1224,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100009796",name:"exports.slowcat",type:"FunctionDeclaration",paramnames:["pats"]}},description:`<p>Concatenation: combines a list of patterns, switching between them successively, one per cycle:</p>
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1484,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern. Returns a new pattern with all values rounded
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1497,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern. Returns a new pattern with all values set to
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1511,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern. Returns a new pattern with all values set to
 ...
 * @returns Pattern
 * @noAutocomplete
 */`,meta:{range:[47374,47478],filename:"pattern.mjs",lineno:1530,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011134",name:"exports.toBipolar",type:"VariableDeclaration"}},description:`<p>Assumes a numerical pattern, containing unipolar values in the range 0 ..</p>
<ol>
 ...
 * @returns Pattern
 * @noAutocomplete
 */`,meta:{range:[47679,47789],filename:"pattern.mjs",lineno:1540,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011156",name:"exports.fromBipolar",type:"VariableDeclaration"}},description:`<p>Assumes a numerical pattern, containing bipolar values in the range -1 .. 1
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1544,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern, containing unipolar values in the range 0 .. 1.
Returns a new pattern with values scaled to the given min/max range.
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1558,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern, containing unipolar values in the range 0 .. 1
Returns a new pattern with values scaled to the given min/max range,
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1572,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Assumes a numerical pattern, containing bipolar values in the range -1 .. 1
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1585,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Allows dividing numbers via list notation using &quot;:&quot;.
 ...
 *   s("~ bd sd ~")
 * )
 */`,meta:{range:[49786,50039],filename:"pattern.mjs",lineno:1613,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011301",name:"exports.compress",type:"VariableDeclaration"}},description:"<p>Compress each cycle into the given timespan, leaving a gap</p>",examples:[`cat(
  s("bd sd").compress(.25,.75),
  s("~ bd sd ~")
 ...
 * @example
 * s("bd sd").fastGap(2)
 */`,meta:{filename:"pattern.mjs",lineno:1626,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>speeds up a pattern like fast, but rather than it playing multiple times as fast would it instead leaves a gap in the remaining space of the cycle. For example, the following will play the sound pattern &quot;bd sn&quot; only once but compressed into the first half of the cycle, i.e. twice as fast.</p>",name:"fastGap",tags:[{originalTitle:"synonyms",title:"synonyms",text:"fastgap",value:"fastgap"}],examples:['s("bd sd").fastGap(2)'],longname:"fastGap",kind:"member",scope:"global"},{comment:`/**
 * Similar to compress, but doesn't leave gaps, and the 'focus' can be bigger than a cycle
 * @example
 * s("bd hh sd hh").focus(1/4, 3/4)
 */`,meta:{range:[51928,52097],filename:"pattern.mjs",lineno:1668,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011643",name:"exports.focus",type:"VariableDeclaration"}},description:"<p>Similar to compress, but doesn't leave gaps, and the 'focus' can be bigger than a cycle</p>",examples:['s("bd hh sd hh").focus(1/4, 3/4)'],name:"focus",longname:"focus",kind:"constant",scope:"global"},{comment:`/** The ply function repeats each event the given number of times.
 * @example
 * s("bd ~ sd cp").ply("<1 2 3>")
 */`,meta:{range:[52364,52490],filename:"pattern.mjs",lineno:1682,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011718",name:"exports.ply",type:"VariableDeclaration"}},description:"<p>The ply function repeats each event the given number of times.</p>",examples:['s("bd ~ sd cp").ply("<1 2 3>")'],name:"ply",longname:"ply",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1715,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Slow down a pattern over the given number of cycles. Like the &quot;/&quot; operator in mini notation.</p>",name:"slow",tags:[{originalTitle:"synonyms",title:"synonyms",text:"sparsity",value:"sparsity"}],memberof:"Pattern",params:[{type:{names:["number","Pattern"]},description:"<p>slow down factor</p>",name:"factor"}],returns:[{description:"<p>Pattern</p>"}],examples:['s("<bd sd> hh").slow(2) // s("[<bd sd> hh]/2")'],scope:"static",longname:"Pattern.slow",kind:"member"},{comment:`/**
 * Carries out an operation 'inside' a cycle.
 * @example
 * "0 1 2 3 4 3 2 1".inside(4, rev).scale('C major').note()
 * // "0 1 2 3 4 3 2 1".slow(4).rev().fast(4).scale('C major').note()
 */`,meta:{range:[53990,54107],filename:"pattern.mjs",lineno:1739,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011863",name:"exports.inside",type:"VariableDeclaration"}},description:"<p>Carries out an operation 'inside' a cycle.</p>",examples:[`"0 1 2 3 4 3 2 1".inside(4, rev).scale('C major').note()
 ...
 */`,meta:{range:[54311,54430],filename:"pattern.mjs",lineno:1749,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100011887",name:"exports.outside",type:"VariableDeclaration"}},description:"<p>Carries out an operation 'outside' a cycle.</p>",examples:[`"<[0 1] 2 [3 4] 5>".outside(4, rev).scale('C major').note()
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1780,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>An alias for {@link firstOf}</p>",name:"every",memberof:"Pattern",params:[{type:{names:["number"]},description:"<p>how many cycles</p>",name:"n"},{type:{names:["function"]},description:"<p>function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],examples:['note("c3 d3 e3 g3").every(4, x=>x.rev())'],scope:"static",longname:"Pattern.every",kind:"member"},{comment:`/**
 * Like layer, but with a single function:
 * @name apply
 * @memberof Pattern
 * @example
 * "<c3 eb3 g3>".scale('C minor').apply(scaleTranspose("0,2,4")).note()
 */`,meta:{filename:"pattern.mjs",lineno:1796,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Like layer, but with a single function:</p>",name:"apply",memberof:"Pattern",examples:[`"<c3 eb3 g3>".scale('C minor').apply(scaleTranspose("0,2,4")).note()`],scope:"static",longname:"Pattern.apply",kind:"member"},{comment:`/**
 * Plays the pattern at the given cycles per minute.
 * @example
 * s("<bd sd>,hh*2").cpm(90) // = 90 bpm
 */`,meta:{range:[56021,56111],filename:"pattern.mjs",lineno:1814,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012006",name:"exports.cpm",type:"VariableDeclaration"}},description:"<p>Plays the pattern at the given cycles per minute.</p>",examples:['s("<bd sd>,hh*2").cpm(90) // = 90 bpm'],name:"cpm",longname:"cpm",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1833,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Nudge a pattern to start later in time. Equivalent of Tidal's ~&gt; operator</p>",name:"late",memberof:"Pattern",params:[{type:{names:["number","Pattern"]},description:"<p>number of cycles to nudge right</p>",name:"cycles"}],returns:[{description:"<p>Pattern</p>"}],examples:['"bd ~".stack("hh ~".late(.1)).s()'],scope:"static",longname:"Pattern.late",kind:"member"},{comment:`/**
 * Plays a portion of a pattern, specified by the beginning and end of a time span. The new resulting pattern is played over the time period of the original pattern:
 *
 * @example
 * s("bd*2 hh*3 [sd bd]*2 perc").zoom(0.25, 0.75)
 * // s("hh*3 [sd bd]*2") // equivalent
 */`,meta:{range:[57239,57532],filename:"pattern.mjs",lineno:1855,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012093",name:"exports.zoom",type:"VariableDeclaration"}},description:"<p>Plays a portion of a pattern, specified by the beginning and end of a time span. The new resulting pattern is played over the time period of the original pattern:</p>",examples:[`s("bd*2 hh*3 [sd bd]*2 perc").zoom(0.25, 0.75)
 ...
 */`,meta:{range:[57890,58095],filename:"pattern.mjs",lineno:1875,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012198",name:"exports.linger",type:"VariableDeclaration"}},description:"<p>Selects the given fraction of the pattern and repeats that part to fill the remainder of the cycle.</p>",params:[{type:{names:["number"]},description:"<p>fraction to select</p>",name:"fraction"}],examples:['s("lt ht mt cp, [hh oh]*2").linger("<1 .5 .25 .125>")'],name:"linger",longname:"linger",kind:"constant",scope:"global"},{comment:`/**
 * Samples the pattern at a rate of n events per cycle. Useful for turning a continuous pattern into a discrete one.
 * @param {number} segments number of segments per cycle
 * @example
 * note(saw.range(0,12).segment(24)).add(40)
 */`,meta:{range:[58336,58450],filename:"pattern.mjs",lineno:1890,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012247",name:"exports.segment",type:"VariableDeclaration"}},description:"<p>Samples the pattern at a rate of n events per cycle. Useful for turning a continuous pattern into a discrete one.</p>",params:[{type:{names:["number"]},description:"<p>number of segments per cycle</p>",name:"segments"}],examples:["note(saw.range(0,12).segment(24)).add(40)"],name:"segment",longname:"segment",kind:"constant",scope:"global"},{comment:`/**
 * Swaps 1s and 0s in a binary pattern.
 * @name invert
 * @synonyms inv
 * @example
 * s("bd").struct("1 0 0 1 0 0 1 0".lastOf(4, invert))
 */`,meta:{filename:"pattern.mjs",lineno:1894,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Swaps 1s and 0s in a binary pattern.</p>",name:"invert",tags:[{originalTitle:"synonyms",title:"synonyms",text:"inv",value:"inv"}],examples:['s("bd").struct("1 0 0 1 0 0 1 0".lastOf(4, invert))'],longname:"invert",kind:"member",scope:"global"},{comment:`/**
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1920,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Superimposes the function result on top of the original pattern, delayed by the given time.</p>",name:"off",memberof:"Pattern",params:[{type:{names:["Pattern","number"]},description:"<p>offset time</p>",name:"time"},{type:{names:["function"]},description:"<p>function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],examples:['"c3 eb3 g3".off(1/8, x=>x.add(7)).note()'],scope:"static",longname:"Pattern.off",kind:"member"},{comment:`/**
 * Returns a new pattern where every other cycle is played once, twice as
 * fast, and offset in time by one quarter of a cycle. Creates a kind of
 * breakbeat feel.
 * @returns Pattern
 */`,meta:{range:[59729,59867],filename:"pattern.mjs",lineno:1940,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012337",name:"exports.brak",type:"VariableDeclaration"}},description:`<p>Returns a new pattern where every other cycle is played once, twice as
fast, and offset in time by one quarter of a cycle. Creates a kind of
 ...
 */`,meta:{filename:"pattern.mjs",lineno:1944,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Reverse all haps in a pattern</p>",name:"rev",memberof:"Pattern",returns:[{description:"<p>Pattern</p>"}],examples:['note("c3 d3 e3 g3").rev()'],scope:"static",longname:"Pattern.rev",kind:"member"},{comment:`/** Like press, but allows you to specify the amount by which each
 ...
 *      ).slow(2)
 */`,meta:{range:[61021,61151],filename:"pattern.mjs",lineno:1980,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012485",name:"exports.pressBy",type:"VariableDeclaration"}},description:`<p>Like press, but allows you to specify the amount by which each
event is shifted. pressBy(0.5) is the same as press, while
 ...
 *      ).slow(2)
 */`,meta:{range:[61327,61414],filename:"pattern.mjs",lineno:1991,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012514",name:"exports.press",type:"VariableDeclaration"}},description:"<p>Syncopates a rhythm, by shifting each event halfway into its timespan.</p>",examples:[`stack(s("hh*4"),
      s("bd mt sd ht").every(4, press)
 ...
 *   s("hh*3")
 * )
 */`,meta:{range:[61510,61585],filename:"pattern.mjs",lineno:2003,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012530",name:"exports.hush",type:"VariableDeclaration"}},description:"<p>Silences a pattern.</p>",examples:[`stack(
  s("bd").hush(),
  s("hh*3")
 ...
 */`,meta:{range:[61751,61848],filename:"pattern.mjs",lineno:2012,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012542",name:"exports.palindrome",type:"VariableDeclaration"}},description:"<p>Applies <code>rev</code> to a pattern every other cycle, so that the pattern alternates between forwards and backwards.</p>",examples:['note("c d e g").palindrome()'],name:"palindrome",longname:"palindrome",kind:"constant",scope:"global"},{comment:`/**
 * Jux with adjustable stereo width. 0 = mono, 1 = full stereo.
 * @name juxBy
 * @synonyms juxby
 * @example
 * s("lt ht mt ht hh").juxBy("<0 .5 1>/2", rev)
 */`,meta:{filename:"pattern.mjs",lineno:2016,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Jux with adjustable stereo width. 0 = mono, 1 = full stereo.</p>",name:"juxBy",tags:[{originalTitle:"synonyms",title:"synonyms",text:"juxby",value:"juxby"}],examples:['s("lt ht mt ht hh").juxBy("<0 .5 1>/2", rev)'],longname:"juxBy",kind:"member",scope:"global"},{comment:`/**
 * The jux function creates strange stereo effects, by applying a function to a pattern, but only in the right-hand channel.
 * @example
 * s("lt ht mt ht hh").jux(rev)
 */`,meta:{range:[62662,62758],filename:"pattern.mjs",lineno:2042,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100012655",name:"exports.jux",type:"VariableDeclaration"}},description:"<p>The jux function creates strange stereo effects, by applying a function to a pattern, but only in the right-hand channel.</p>",examples:['s("lt ht mt ht hh").jux(rev)'],name:"jux",longname:"jux",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{filename:"pattern.mjs",lineno:2046,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Superimpose and offset multiple times, applying the given function each time.</p>",name:"echoWith",tags:[{originalTitle:"synonyms",title:"synonyms",text:"echowith, stutWith, stutwith",value:"echowith, stutWith, stutwith"}],params:[{type:{names:["number"]},description:"<p>how many times to repeat</p>",name:"times"},{type:{names:["number"]},description:"<p>cycle offset between iterations</p>",name:"time"},{type:{names:["function"]},description:"<p>function to apply, given the pattern and the iteration index</p>",name:"func"}],examples:[`"<0 [2 4]>"
.echoWith(4, 1/8, (p,n) => p.add(n*2))
 ...
 */`,meta:{range:[67020,67135],filename:"pattern.mjs",lineno:2174,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100013006",name:"exports.ribbon",type:"VariableDeclaration"}},description:"<p>Loops the pattern inside at <code>offset</code> for <code>cycles</code>.</p>",params:[{type:{names:["number"]},description:"<p>start point of loop in cycles</p>",name:"offset"},{type:{names:["number"]},description:"<p>loop length in cycles</p>",name:"cycles"}],examples:[`// Looping a portion of randomness
 ...
 */`,meta:{range:[67512,67666],filename:"pattern.mjs",lineno:2186,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100013062",name:"exports.",type:"VariableDeclaration"}},description:"<p>Sets the color of the hap in visualizations like pianoroll or highlighting.</p>",name:"",longname:"",kind:"constant",scope:"global"},{comment:`/**
 *
 ...
 * .velocity(".4 1")
 */`,meta:{filename:"pattern.mjs",lineno:2190,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Sets the velocity from 0 to 1. Is multiplied together with gain.</p>",name:"velocity",examples:[`s("hh*8")
.gain(".4!2 1 .4!2 1 .4 1")
 ...
 */`,meta:{filename:"pattern.mjs",lineno:2203,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Multiplies the hap duration with the given factor.
 ...
 *
 */`,meta:{filename:"pattern.mjs",lineno:2222,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Cuts each sample into the given number of parts, allowing you to explore a technique known as 'granular synthesis'.
 ...
 * samples({ rhodes: 'https://cdn.freesound.org/previews/132/132051_316502-lq.mp3' })
 * s("rhodes").loopAt(4)
 */`,meta:{filename:"pattern.mjs",lineno:2252,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:"<p>Makes the sample fit the given number of cycles by changing the speed.</p>",name:"loopAt",memberof:"Pattern",returns:[{description:"<p>Pattern</p>"}],examples:[`samples({ rhodes: 'https://cdn.freesound.org/previews/132/132051_316502-lq.mp3' })
 ...
 */`,meta:{filename:"pattern.mjs",lineno:2331,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{}},description:`<p>Makes the sample fit the given number of cycles and cps value, by
changing the speed. Please note that at some point cps will be
given by a global clock and this function will be
 ...
 *
 */`,meta:{range:[1579,1619],filename:"signal.mjs",lineno:35,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015665",name:"exports.saw",type:"VariableDeclaration"}},description:"<p>A sawtooth signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:['"c3 [eb3,g3] g2 [g3,bb3]".note().clip(saw.slow(4))',"saw.range(0,8).segment(8).scale('C major').slow(4).note()"],name:"saw",longname:"saw",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[1868,1908],filename:"signal.mjs",lineno:48,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015703",name:"exports.sine",type:"VariableDeclaration"}},description:"<p>A sine signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["sine.segment(16).range(0,15).slow(2).scale('C minor').note()"],name:"sine",longname:"sine",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2072,2126],filename:"signal.mjs",lineno:58,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015711",name:"exports.cosine",type:"VariableDeclaration"}},description:"<p>A cosine signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["stack(sine,cosine).segment(16).range(0,15).slow(2).scale('C minor').note()"],name:"cosine",longname:"cosine",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2325,2386],filename:"signal.mjs",lineno:69,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015741",name:"exports.square",type:"VariableDeclaration"}},description:"<p>A square signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["square.segment(2).range(0,7).scale('C minor').note()"],name:"square",longname:"square",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2570,2608],filename:"signal.mjs",lineno:80,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015766",name:"exports.tri",type:"VariableDeclaration"}},description:"<p>A triangle signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["tri.segment(8).range(0,7).scale('C minor').note()"],name:"tri",longname:"tri",kind:"constant",scope:"global"},{comment:`/**
 * A discrete pattern of numbers from 0 to n-1
 * @example
 * run(4).scale('C4 major').note()
 * // "0 1 2 3".scale('C4 major').note()
 */`,meta:{range:[3563,3624],filename:"signal.mjs",lineno:123,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015921",name:"exports.run",type:"VariableDeclaration"}},description:"<p>A discrete pattern of numbers from 0 to n-1</p>",examples:[`run(4).scale('C4 major').note()
 ...
 */`,meta:{range:[3915,3953],filename:"signal.mjs",lineno:138,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100015947",name:"exports.rand2",type:"VariableDeclaration"}},description:"<p>A continuous pattern of random numbers, between -1 and 1</p>",name:"rand2",longname:"rand2",kind:"constant",scope:"global"},{comment:`/**
 ...
 * @param {*} xs
 * @returns {Pattern}
 */`,meta:{range:[4900,4987],filename:"signal.mjs",lineno:172,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016074",name:"exports.chooseWith",type:"VariableDeclaration"}},description:`<p>Choose from the list of values (or patterns of values) using the given
 ...
 * @param {*} xs
 * @returns {Pattern}
 */`,meta:{range:[5189,5278],filename:"signal.mjs",lineno:183,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016090",name:"exports.chooseInWith",type:"VariableDeclaration"}},description:`<p>As with {chooseWith}, but the structure comes from the chosen values, rather
 ...
 */`,meta:{range:[5444,5498],filename:"signal.mjs",lineno:192,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016106",name:"exports.choose",type:"VariableDeclaration"}},description:"<p>Chooses randomly from the given list of elements.</p>",params:[{type:{names:["any"]},variable:!0,description:"<p>values / patterns to choose from.</p>",name:"xs"}],returns:[{type:{names:["Pattern"]},description:`<ul>
 ...
 * @param  {...any} xs
 * @returns {Pattern}
 */`,meta:{range:[5723,5801],filename:"signal.mjs",lineno:201,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016118",name:"Pattern.prototype.choose",type:"FunctionExpression",paramnames:["xs"]}},description:`<p>Chooses from the given list of values (or patterns of values), according
to the pattern that the method is called on. The pattern should be in
 ...
 * @param  {...any} xs
 * @returns {Pattern}
 */`,meta:{range:[5956,6049],filename:"signal.mjs",lineno:211,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016134",name:"Pattern.prototype.choose2",type:"FunctionExpression",paramnames:["xs"]}},description:`<p>As with choose, but the pattern that this method is called on should be
 ...
 * @example
 * "bd | hh | sd".s().fast(4)
 */`,meta:{range:[6233,6306],filename:"signal.mjs",lineno:223,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100016152",name:"exports.chooseCycles",type:"VariableDeclaration"}},description:"<p>Picks one of the elements at random each cycle.</p>",returns:[{type:{names:["Pattern"]}}],examples:['chooseCycles("bd", "hh", "sd").s().fast(4)','"bd | hh | sd".s().fast(4)'],name:"chooseCycles",longname:"chooseCycles",kind:"constant",scope:"global"},{comment:`/**
 ...
 * @noAutocomplete
 */`,meta:{range:[2500,2667],filename:"util.mjs",lineno:63,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100027009",name:"exports.getFreq",type:"VariableDeclaration"}},deprecated:"does not appear to be referenced or invoked anywhere in the codebase",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"getFreq",longname:"getFreq",kind:"constant",scope:"global"},{comment:`/**
 * @deprecated only used in workshop (first-notes)
 * @noAutocomplete
 */`,meta:{range:[2826,2945],filename:"util.mjs",lineno:75,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/core",code:{id:"astnode100027048",name:"exports.midi2note",type:"VariableDeclaration"}},deprecated:"only used in workshop (first-notes)",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"midi2note",longname:"midi2note",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{range:[4583,5897],filename:"index.mjs",lineno:137,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csound",code:{id:"astnode100028926",name:"exports.csoundm",type:"VariableDeclaration"}},description:`<p>Sends notes to Csound for rendering with MIDI semantics. The hap value is
...
p6 -- Strudel controls, as a string.</p>`,name:"csoundm",longname:"csoundm",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[1246,1252],filename:"csoundac.mjs",lineno:30,columnno:4,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029173",name:"csound"}},description:`<p>C S O U N D A C   M O D U L E   F O R   S T R U D E L</p>
 ...
 */`,meta:{range:[1896,2101],filename:"csoundac.mjs",lineno:59,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029226",name:"exports.frequencyToMidiReal",type:"FunctionDeclaration",paramnames:["frequency"]}},description:`<p>A utility that returns the MIDI key number for a frequency in Hz,
as a real number allowing fractions for microtones.</p>`,name:"frequencyToMidiReal",longname:"frequencyToMidiReal",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[2211,2344],filename:"csoundac.mjs",lineno:70,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029263",name:"exports.frequencyToMidiInteger",type:"FunctionDeclaration",paramnames:["frequency"]}},description:`<p>A utility that returns the MIDI key number for a frequency in Hz,
as the nearest integer.</p>`,name:"frequencyToMidiInteger",longname:"frequencyToMidiInteger",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[2576,2797],filename:"csoundac.mjs",lineno:81,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029280",name:"exports.csacLoad",type:"FunctionDeclaration",paramnames:[]}},description:`<p>Initializes the CsoundAC WebAssembly library. Normally,
this is set in globalThis by a containing program.
This function should be called from module scope in
Strudel code before creating any Patterns.</p>`,name:"csacLoad",longname:"csacLoad",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[3019,3353],filename:"csoundac.mjs",lineno:97,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029311",name:"exports.csacCopy",type:"FunctionDeclaration",paramnames:["a","b"]}},description:`<p>A utility for making a <em>value</em> copy of a Chord (or a Scale, which
is derived from Chord). Object b is resized to the size of a, and a's
pitches are copied to b. Currently, only pitches are copied.</p>`,name:"csacCopy",longname:"csacCopy",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[3923,4180],filename:"csoundac.mjs",lineno:117,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029363",name:"exports.csacChord",type:"FunctionDeclaration",paramnames:["name"]}},description:`<p>Creates and initializes a CsoundAC Chord object. This function should be
called from module scope in Tidal code before creating any Patterns. The
Chord class is based on Dmitri Tymoczko's model of chord space, and
represents an equally tempered chord of the specified number of voices as
a single point in chord space, where each dimension of the space
...
neo-Riemannian music theory.</p>`,name:"csacChord",longname:"csacChord",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[4339,4822],filename:"csoundac.mjs",lineno:129,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029401",name:"exports.chordT",type:"VariableDeclaration"}},description:`<p>A Pattern that transposes the specified Chord by the specified number
of semitones. This enables transposing Chords in a patternified way.</p>`,name:"chordT",longname:"chordT",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[4964,5478],filename:"csoundac.mjs",lineno:145,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029481",name:"exports.chordI",type:"VariableDeclaration"}},description:`<p>A Pattern that reflects the specified Chord in the specified center.
This enables inverting Chords in a patternified way.</p>`,name:"chordI",longname:"chordI",kind:"constant",scope:"global"},{comment:`/**
  ...
  * patternified way.
  */`,meta:{range:[5819,6274],filename:"csoundac.mjs",lineno:165,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029564",name:"exports.chordK",type:"VariableDeclaration"}},description:`<p>A Pattern that transforms the specified Chord using the interchange by
inversion operation of the Generalized Contextual Group of Fiore and
Satyendra. This enables exchanging a &quot;major&quot; sounding pitch-class set with
the corresponding &quot;minor&quot; sounding pitch-class set, and vice versa, in a
patternified way.</p>`,name:"chordK",longname:"chordK",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[6802,7315],filename:"csoundac.mjs",lineno:186,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029643",name:"exports.chordQ",type:"VariableDeclaration"}},description:`<p>A Pattern that transforms the specified Chord using the contextual
transposition operation of the Generalized Contextual Group of Fiore and
Satyendra. This enables tranposing the specified Chord by the specified
...
contextual transpositions to Chords in a patternified way.</p>`,name:"chordQ",longname:"chordQ",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[7433,8053],filename:"csoundac.mjs",lineno:202,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029729",name:"exports.chordNV",type:"VariableDeclaration"}},description:`<p>A Pattern that conforms <em>notes</em> to the closest <em>note</em> of the
specified (presumably voiced) Chord.</p>`,name:"chordNV",longname:"chordNV",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[8170,8803],filename:"csoundac.mjs",lineno:223,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029819",name:"exports.chordN",type:"VariableDeclaration"}},description:`<p>A Pattern that conforms <em>pitch-classes</em> to the closest <em>pitch-class set</em>
of the specified Chord.</p>`,name:"chordN",longname:"chordN",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[9395,9648],filename:"csoundac.mjs",lineno:250,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029912",name:"exports.csacScale",type:"FunctionDeclaration",paramnames:["name"]}},description:`<p>Creates and initializes a CsoundAC Scale object. This function should be
called from module scope in Tidal code before creating any Patterns. The
Scale class is derived from the CsoundAC Chord class, but has been
equipped with additional methods based on Dimitri Tymoczko's model of
functional harmony. This enables algorithmically generating Chords from
...
dominants and tonicizations based on scale degree.</p>`,name:"csacScale",longname:"csacScale",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[9930,10366],filename:"csoundac.mjs",lineno:264,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100029950",name:"exports.scaleS",type:"VariableDeclaration"}},description:`<p>A Pattern that returns the Chord corresponding to the specified scale step
of the Scale object. This enables generating tonal chord progressions in a
patternified way. The Chord is returned in the argument and can then be
used in Chord-based Patterns.</p>`,name:"scaleS",longname:"scaleS",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[10693,11138],filename:"csoundac.mjs",lineno:279,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030018",name:"exports.scaleT",type:"VariableDeclaration"}},description:`<p>A Pattern that transposes the specified Chord by the specified number of
...
is returned in the argument and can then be used in Chord-based Patterns.</p>`,name:"scaleT",longname:"scaleT",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[11520,12508],filename:"csoundac.mjs",lineno:295,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030083",name:"exports.scaleM",type:"VariableDeclaration"}},description:`<p>A Pattern that modulates from one Scale to another, assuming that the
specified Chord is a pivot chord in the specified Scale. This enables
generating correct tonal key changes in a patternified way. The new
Scale is returned in the argument and can then be used in Scale-based
Patterns. The specified index picks one of the possible modulations.</p>`,name:"scaleM",longname:"scaleM",kind:"constant",scope:"global"},{comment:`/**
  ...
  * specified Scale.
  */`,meta:{range:[12609,13191],filename:"csoundac.mjs",lineno:324,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030215",name:"exports.scaleN",type:"VariableDeclaration"}},description:`<p>A Pattern that conforms notes to the closest pitch-class of the
specified Scale.</p>`,name:"scaleN",longname:"scaleN",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[13975,14291],filename:"csoundac.mjs",lineno:353,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030290",name:"exports.csacPitv",type:"FunctionDeclaration",paramnames:["voices","range"]}},description:`<p>Creates and initializes a CsoundAC PITV object. This function should be
called from module scope in Tidal code before creating any Patterns. The
PITV object is a 4 dimensional cyclic group whose dimensions are TI set
class (P), chord inversion (I), pitch-class transposition (T), and index
of octavewise revoicing within the specified range (V). The elements of
...
generating harmonies and voicings by independently varying P, I, T, and V.</p>`,name:"csacPitv",longname:"csacPitv",kind:"function",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[14432,14654],filename:"csoundac.mjs",lineno:370,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030356",name:"exports.pitvP",type:"VariableDeclaration"}},description:`<p>A Pattern that sets the indicated set-type index in the PITV object. This
enables mutating Chords in a patternified way.</p>`,name:"pitvP",longname:"pitvP",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[14808,15010],filename:"csoundac.mjs",lineno:382,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030403",name:"exports.pitvI",type:"VariableDeclaration"}},description:`<p>A Pattern that sets the indicated index of inversion in the PITV object.
This enables inverting a PITV element in a patternified way.</p>`,name:"pitvI",longname:"pitvI",kind:"constant",scope:"global"},{comment:`/**
  ...
  * way.
  */`,meta:{range:[15187,15409],filename:"csoundac.mjs",lineno:395,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030448",name:"exports.pitvT",type:"VariableDeclaration"}},description:`<p>A Pattern that sets the indicated index of pitch-class transposition in
the PITV object. This enables transposing a PITV element in a patternified
way.</p>`,name:"pitvT",longname:"pitvT",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[15574,15796],filename:"csoundac.mjs",lineno:407,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030495",name:"exports.pitvV",type:"VariableDeclaration"}},description:`<p>A Pattern that sets the indicated index of octavewise revoicing in the
PITV object. This enables revoicing a PITV element in a patternified way.</p>`,name:"pitvV",longname:"pitvV",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[16002,16690],filename:"csoundac.mjs",lineno:420,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030542",name:"exports.pitvNV",type:"VariableDeclaration"}},description:`<p>A Pattern that that conforms the notes of a Pattern to the current
...
of the chord <em>voicing</em> of the PITV element.</p>`,name:"pitvNV",longname:"pitvNV",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[16901,17732],filename:"csoundac.mjs",lineno:443,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030645",name:"exports.pitvN",type:"VariableDeclaration"}},description:`<p>A Pattern that conforms the notes of a Pattern to the current
...
class</em> of the <em>pitch-class set</em> of the PITV element.</p>`,name:"pitvN",longname:"pitvN",kind:"constant",scope:"global"},{comment:`/**
  ...
  */`,meta:{range:[18224,18590],filename:"csoundac.mjs",lineno:479,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/csoundac",code:{id:"astnode100030755",name:"exports.userpattern",type:"VariableDeclaration"}},description:`<p>A Pattern that calls a closure that may be defined in a user level
Strudel patch. To be used something like this:
const c = .88;
let y = .5;
const logistic = function(pat, hap) {
 ...
 * s("[bd ~]*2, [~ hh]*2, ~ sd")
 *
 */`,meta:{range:[5036,6425],filename:"sampler.mjs",lineno:151,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/webaudio",code:{id:"astnode100057408",name:"exports.samples",type:"VariableDeclaration"}},description:"<p>Loads a collection of samples to use with <code>s</code></p>",examples:[`samples('github:tidalcycles/Dirt-Samples/master');
