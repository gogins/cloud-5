...
//.pianoroll({fold:1})`,jr=`// Koji Kondo - Princess Zelda's Rescue
stack(
  // melody
...
.pianoroll({fold:1})
`,Br=`// adapted from a Barry Harris excercise
"0,2,[7 6]"
  .add("<0 1 2 3 4 5 7 8>")
  .scale('C bebop major')
  .transpose("<0 1 2 1>/8")
  ...
  .note().piano()
  .color('#00B8D4')
`,$r=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
samples({
...
//.pianoroll({fold:1})`,Nr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
samples({
...
stack(
 ...
 .note().piano()`,Pr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
stack(
  ...
  .fast(2/3)
  .pianoroll({})`,Gr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
stack(
  ...
  .pianoroll()
`,Mr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
stack(
  ...
  .velocity(.8)
  .slow(2)
  .pianoroll({maxMidi:100,minMidi:20})`,Ur=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
"<0 2 [4 6](3,4,2) 3*2>"
.scale('D minor')
.color('salmon')
...
.echo(4, 1/8, .5)
.note().piano()
.pianoroll()`,Lr=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  \`<
  ...
  >\`
  .legato(.5)
).fast(2).note()`,Wr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
samples({
...
// strudel disable-highlighting`,Hr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
"[-7*3],0,2,6,[8 7]"
...
.slow(2)
.note().piano()
//.pianoroll({maxMidi:160})`,Jr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
stack(
  ...
  .slow(3/2)`,Yr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
samples({
...
"C^7 Am7 Dm7 G7".slow(2).voicings('lefthand')
  ...
  `,Vr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
.pianoroll({vertical:1})`,Kr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
s("p")
  ...
  .decay(.1)
  .sustain(.6)
  `,Xr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
stack(
    s("bd <sd cp>")
    .delay("<0 .5>")
    .delaytime(".16 | .33")
    .delayfeedback(".6 | .8")
  ).sometimes(x=>x.speed("-1"))`,Qr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
stack(
    s("bd <sd cp>")
    .delay(.5)
    ...
    .delayfeedback(.7)
    .orbit(2)
  ).sometimes(x=>x.speed("-1"))`,Zr=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
stack(
  ...
  .mask("<1 0>/8")
).slow(5)`,en=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
stack(
  ...
  .release(.1).room(.5)
)`,sn=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
`,rn=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
stack(
...
)`,nn=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
await samples('github:tidalcycles/Dirt-Samples/master')
...
).reset("<x@7 x(5,8,-1)>")`,on=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
...
.pianoroll()`,an=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// by Felix Roos
await loadCsound\`
instr CoolSynth
    iduration = p3
...
)`,cn=`// licensed with CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
`,hn=Object.freeze(Object.defineProperty({__proto__:null,swimming:Rr,giantSteps:Fr,zeldasRescue:jr,caverave:Dr,sampleDrums:Or,barryHarris:Br,blippyRhodes:$r,wavyKalimba:Nr,festivalOfFingers:Ir,undergroundPlumber:Pr,bridgeIsOver:Gr,goodTimes:Mr,echoPiano:Ur,sml1:Lr,randomBells:Wr,waa2:qr,hyperpop:zr,festivalOfFingers3:Hr,meltingsubmarine:Jr,outroMusic:Yr,bassFuge:Vr,chop:Kr,delay:Xr,orbit:Qr,belldub:Zr,dinofunk:en,sampleDemo:tn,holyflute:sn,flatrave:rn,amensister:nn,juxUndTollerei:on,csoundDemo:an,loungeSponge:ln,arpoon:cn},Symbol.toStringTag,{value:"Module"}));Xe();const He=Ys("https://pidxdsxphlhzjnzmifth.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBpZHhkc3hwaGxoempuem1pZnRoIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NTYyMzA1NTYsImV4cCI6MTk3MTgwNjU1Nn0.bqlw7802fsWRnqU5BLYtmXk_k-D1VFmbkHMywWc15NM"),Je=[T(()=>import("./chunks/prebake.5a4b2523.js").then(n=>n.O),["chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.d02d4673.js"),["chunks/index.d02d4673.js","chunks/voicings.8325b92a.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.69aa2255.js"),["chunks/index.69aa2255.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.f42490ed.js"),["chunks/index.f42490ed.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.005c56c2.js"),["chunks/index.005c56c2.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.772bda14.js"),["chunks/index.772bda14.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/osc.ebf71003.js"),["chunks/osc.ebf71003.js","chunks/index.ee58e7ae.js","chunks/prebake.5a4b2523.js"]),T(()=>import("./chunks/serial.99426d6b.js"),["chunks/serial.99426d6b.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/index.9ba4edbc.js"),["chunks/index.9ba4edbc.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/csound.0b32228b.js"),["chunks/csound.0b32228b.js","chunks/preload-helper.1de719f8.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js"]),T(()=>import("./chunks/csoundac.aeba8319.js"),["chunks/csoundac.aeba8319.js","chunks/prebake.5a4b2523.js","chunks/index.ee58e7ae.js","chunks/voicings.8325b92a.js"])];Qe(Ze,{WebDirt:Ks},...Je);let ke=[];const un=Be();let Y,Ye;typeof window<"u"&&(Y=et(),Ye=()=>Y.clearRect(0,0,Y.canvas.height,Y.canvas.width));Promise.all([...Je,un]).then(n=>{ke=Object.entries(tt()||{})});const dn=()=>$e().currentTime;async function fn(){try{const e=window.location.href.split("?")[1]?.split("#")?.[0],t=window.location.href.split("#")[1];if(t)return atob(decodeURIComponent(t||""));if(e)return He.from("code").select("code").eq("hash",e).then(({data:s,error:r})=>{if(r&&console.warn("failed to load hash",err),s.length)return console.log("load hash from database",e),s[0].code})}catch(n){console.warn("failed to decode",n)}}function Ve(){const n=Object.entries(hn),e=r=>r[Math.floor(Math.random()*r.length)],[t,s]=e(n);return{name:t,code:s}}const{code:pn,name:mn}=Ve(),gn=_.exports.createContext(null);function Rn({embedded:n=!1}){const e=n||window.location!==window.parent.location,[t,s]=_.exports.useState(),[r,a]=_.exports.useState(),[l,h]=_.exports.useState(""),[f,i]=_.exports.useState(!1),[o,c]=_.exports.useState(!1),{code:d,setCode:u,scheduler:p,evaluate:g,activateCode:b,isDirty:y,activeCode:v,pattern:w,started:F,stop:B,error:I}=it({initialCode:"// LOADING",defaultOutput:st,getTime:dn,autolink:!0,beforeEval:()=>{rt(),Ee(),c(!0)},afterEval:()=>{c(!1)},onToggle:C=>!C&&Ee(!1),drawContext:Y});_.exports.useEffect(()=>{fn().then(C=>{C||h("intro"),O(`Welcome to Strudel! ${C?"I have loaded the code from the URL.":`A random code snippet named "${mn}" has been loaded!`} Press play or hit ctrl+enter to run it!`,"highlight"),u(C||pn)})},[]),bn(_.exports.useCallback(async C=>{(C.ctrlKey||C.altKey)&&(C.code==="Enter"?(C.preventDefault(),ot(t),await b()):C.code==="Period"&&(B(),C.preventDefault()))},[b,B,t])),at({view:t,pattern:w,active:F&&!v?.includes("strudel disable-highlighting"),getTime:()=>p.now()});const G=_.exports.useCallback(C=>{u(C),F&&O("[edit] code changed. hit ctrl+enter to update")},[F]),de=_.exports.useCallback(C=>{},[]),Se=async()=>{await $e().resume(),F?(O("[repl] stopped. tip: you can also stop by pressing ctrl+dot","highlight"),B()):(O("[repl] started. tip: you can also start by pressing ctrl+enter","highlight"),b())},fe={embedded:n,started:F,pending:o,isDirty:y,lastShared:r,activeCode:v,activeFooter:l,setActiveFooter:h,handleChangeCode:G,handleTogglePlay:Se,handleUpdate:()=>{y&&b(),O("[repl] code updated! tip: you can also update the code by pressing ctrl+enter","highlight")},handleShuffle:async()=>{const{code:C,name:Z}=Ve();O(`[repl] \u2728 loading random tune "${Z}"`),Ye(),nt(),await Be(),await g(C,!1)},handleShare:async()=>{const C=v||d;if(r===C){O("Link already generated!","error");return}const Z=qe(12),{data:xn,error:pe}=await He.from("code").insert([{code:C,hash:Z}]);if(pe){console.log("error",pe);const ee=`Error: ${pe.message}`;O(ee)}else{a(v||d);const ee=window.location.origin+"?"+Z;await navigator.clipboard.writeText(ee);const Te=`Link copied to clipboard: ${ee}`;alert(Te),O(Te,"highlight")}},isZen:f,setIsZen:i};return m.exports.jsx(gn.Provider,{value:fe,children:m.exports.jsxs("div",{className:R("h-screen flex flex-col"),children:[m.exports.jsx(Er,{context:fe}),m.exports.jsx("section",{className:"grow flex text-gray-100 relative overflow-auto cursor-text pb-0",id:"code",children:m.exports.jsx(lt,{value:d,onChange:G,onViewChanged:s,onSelectionChange:de})}),I&&m.exports.jsx("div",{className:"text-red-500 p-4 bg-lineblack animate-pulse",children:I.message||"Unknown Error :-/"}),e&&!F&&m.exports.jsxs("button",{onClick:()=>Se(),className:"text-white text-2xl fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[1000] m-auto p-4 bg-black rounded-md flex items-center space-x-2",children:[m.exports.jsx(ze,{className:"w-6 h-6"}),m.exports.jsx("span",{children:"play"})]}),!e&&m.exports.jsx(sr,{context:fe})]})})}function Ke(n,e,t=!1){_.exports.useEffect(()=>(document.addEventListener(n,e,t),()=>{document.removeEventListener(n,e,t)}),[e])}function bn(n){Ke("keydown",n,!0)}export{Rn as Repl,gn as ReplContext,ke as loadedSamples,Ke as useEvent};
