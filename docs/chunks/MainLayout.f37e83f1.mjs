...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<nav class="flex justify-between py-2 px-4 items-center h-14 max-h-14 bg-[#161616] astro-BJPXWKN3" title="Top Navigation">
  <!--     <div class="menu-toggle">
      <SidebarToggle client:idle />
    </div> -->
  <div class="flex overflow-visible items-center grow astro-BJPXWKN3" style="overflow:visible">
    <a href="/" class="flex items-center text-2xl space-x-2 astro-BJPXWKN3">
      <h1 class="text-white font-bold flex space-x-2 items-baseline text-xl astro-BJPXWKN3">
        <span class="astro-BJPXWKN3">🌀</span>
        <div class="flex space-x-1 items-baseline astro-BJPXWKN3">
          <span class=" astro-BJPXWKN3">strudel</span>
          <span class="text-sm astro-BJPXWKN3">DOCS</span>
        </div>
      </h1>
    </a>
  </div>
  
  <div class="search-item h-10 astro-BJPXWKN3">
    <!--     <Search client:idle /> -->
  </div>
  <a href="/" class="hidden md:flex cursor-pointer items-center space-x-1 astro-BJPXWKN3">${renderComponent($$result, "CommandLineIcon", CommandLineIcon, { "className": "w-5 h-5 astro-BJPXWKN3" })}<span class="astro-BJPXWKN3">go to REPL</span>
  </a>
  <div class="md:hidden astro-BJPXWKN3">
    ${renderComponent($$result, "MobileNav", MobileNav, { "sidebar": sidebar, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "/Users/michaelgogins/cloud-music/strudel/website/src/docs/MobileNav", "client:component-export": "default", "class": "astro-BJPXWKN3" })}
  </div>
</nav>
...
const $$PageContent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  frontmatter.title;
  return renderTemplate`${maybeRenderHead($$result)}<article id="article" class="content astro-663FUVDK">
  <section class="main-section astro-663FUVDK">
    <!-- TODO: add dropdown toc on mobile -->
    <!--     <nav class="block sm:hidden mb-8">
      <span>On this Page:</span>
      <TableOfContents client:media="(max-width: 50em)" headings={headings} />
    </nav> -->
    <div class="prose prose-invert max-w-full pb-8 astro-663FUVDK">
      ${renderSlot($$result, $$slots["default"])}
    </div>
  </section>
  <nav class="block sm:hidden astro-663FUVDK">
    ${renderComponent($$result, "MoreMenu", $$MoreMenu, { "editHref": githubEditUrl, "class": "astro-663FUVDK" })}
  </nav>
</article>
`;
...
const $$RightSidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result, "TableOfContents", TableOfContents, { "client:media": "(min-width: 50em)", "headings": headings, "client:component-hydration": "media", "client:component-path": "/Users/michaelgogins/cloud-music/strudel/website/src/components/RightSidebar/TableOfContents", "client:component-export": "default" })}
