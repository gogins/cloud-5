...
- [`cloud5-example-simple.html`](cloud5-example-simple.html): a very simple composition used 
  to illustrate my paper on cloud-music.
- [`cloud5-example-visual-music.html`](cloud5-example-visual-music.html): 
  always-on visual music produced by a GLSL shader, which is sampled and 
  shaped using CsoundAC.
- [`cloud5-example-strudel.html`](cloud5-example-strudel.html): always-on 
  music produced by a Strudel patch with audio that is also visualized. This  
  piece is live-codeable.
